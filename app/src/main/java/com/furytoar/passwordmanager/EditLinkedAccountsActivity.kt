...
import com.furytoar.passwordmanager.adapters.LinkedAccountsAdapter
import com.furytoar.passwordmanager.databinding.ActivityEditLinkedAccountsBinding
...
class EditLinkedAccountsActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityEditLinkedAccountsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditLinkedAccountsBinding.inflate(layoutInflater)
        ...
        clAddNewLink = binding.clAddNewLink
        ivIcon = binding.ivLinkedAccountAdd
        etAddLinkedAccount = binding.etAddLinkedAccount
        tvAddNewLink = binding.tvAddNewLink
        btnConfirmLink = binding.btnAddLink
    ...
    override fun onStart() {
        super.onStart()
        rvLinkedAccounts = binding.rvEditLinkedAccounts
